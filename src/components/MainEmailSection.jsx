...
function MainEmailSection({ email }) {
  const data = {
    id: "1",
    body:
  ...
  return (
    <div className="main-email-section">
      <div className="main-email-section-header">
        <Avatar name={email.from.name} />
        <div className="main-email-details-container">
          <h2>{email.subject}</h2>
          <p>17/01/2023 10:30am</p>
        </div>
        <button className="mark-favorite-btn">Mark as favorite</button>
      </div>
